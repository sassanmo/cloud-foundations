...
variable "agent_role_arn" {
  description = "IAM role ARN for the Bedrock agent (required if agent_name is provided)"
  type        = string
  default     = null
}
...
variable "knowledge_base_role_arn" {
  description = "IAM role ARN for the knowledge base (required if knowledge_base_name is provided)"
  type        = string
  default     = null
}
...
variable "kms_key_arn" {
  description = "KMS key ARN for encryption (required if guardrail_name is provided)"
  type        = string
  default     = null
}
